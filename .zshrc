...
# command-not-found fzf history-substring-search fzf-tab zsh-syntax-highlighting timer
...
#export PATH=/c/Games/ImageMagick:$PATH

# ===== go get needs vpn ==== enable exports
